...
function esPrimo(numero) {
  ...
  if (numero%1===0) {
    ...
    if (numero===2) {return true} else if (numero%2===0) {return false};
    if (numero===3) {return true} else if (numero%3===0) {return false};
    if (numero===5) {return true} else if (numero%5===0) {return false};
    if (numero===7) {return true} else if (numero%7===0) {return false};
    for (let i = 8; i < (Math.floor(Math.sqrt(numero))); i++) {
